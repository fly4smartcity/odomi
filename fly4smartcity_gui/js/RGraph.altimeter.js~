...
/* MODIFICATO VERSO LA RIGA 279 **********************************
MODIFICATO FUNZIONE GROW/
TUTTE E DUE SCALATE -> CERCA LA FRASE PER IL PUNTO DOVE CI SONO TUTTE E DUE LE FRECCE
...
/**
    ...
    */
    RGraph.Odometer = function (id, start, end, value)
    {
        ...
        */
	    ...
	    'chart.needle.color2':	    'red',//AGGIUNTO
    ...
    /************************************HO COMMENTATO QUESTO PEZZO PER FAR MUOVERE LA LANCETTA COME PIACE A ME 
            /**
    ...
    ******************************************************************************/
            ...
            */
            ...
            // Draw the needle TUTTE E DUE SCALATE
            this.DrawNeedle(this.value/10, prop['chart.needle.color']);
            this.DrawNeedle(this.value/100, prop['chart.needle.color2'],55);//l'ultimo è il val in % della lunghezza della seconda lancetta in funzione della principale
            /**
            ...
            */
            if (prop['chart.needle.extra'].length > 0) {
                for (var i=0; i<prop['chart.needle.extra'].length; ++i) {
                    ...
                    this.DrawNeedle(needle[0]/100, needle[1], needle[2]);/*************************************************************************************
MODIFICATA PER ADATTARE LA FRECCIA ALLE CENTINAIA
************************************************************************************/
                }
            }
        ...
        */
        this.grow = function ()
        {
            ...
            function iterator ()
            {
                ...
                if (frame++ < frames) {
                    RG.Effects.updateCanvas(iterator);// HO COMMENTATO QUESTA RIGA PER FERMARE L'ANIMAZIONE
                } else {
                    callback(obj);
                }
            }

            //iterator();// HO COMMENTATO QUESTA FUNZ FERMARE L'ANIMAZIONE
            RG.redrawCanvas(obj.canvas);// HO TOLTO L'ANIMAZIONE E AGGIORNO DIRETTAMENTE L'OGGETTO
