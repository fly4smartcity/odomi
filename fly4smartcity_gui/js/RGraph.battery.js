    ...
    RGraph.VProgress = function (id, value, max)
    {
        ...
        */
        this.grow   = function ()
        {
            ...
            //RGraph.clear(obj.canvas);// HO TOLTO L'ANIMAZIONE E AGGIORNO DIRETTAMENTE L'OGGETTO
            RGraph.redrawCanvas(obj.canvas);// HO TOLTO L'ANIMAZIONE E AGGIORNO DIRETTAMENTE L'OGGETTO
            return this;
        };
