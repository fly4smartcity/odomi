    ...
    */
    RGraph.Gauge = function (id, min, max, value)
    {
        ...
        */
	    ...
	    'chart.txtbox.scale.decimals': 0,//aggiunto io
            'chart.scale.point':    '.',
            'chart.scale.thousand': ',',
            'chart.units.pre':      '',
            'chart.units.post':     '',
            'chart.value.text':     false,
	    'chart.value.text.x.pos': 0,//AGGIUNTO IO
        ...
        this.DrawLabels = function ()
        {
            ...
            */
            if (prop['chart.value.text']) {
                ...
                var x = this.centerx + (prop['chart.value.text.x.pos'] * this.radius);
                ...
                RG.Text2(this, {'font':font,
                               ...
                               'x':x,
                               'y':y,
                               'text':RG.number_format(this, this.value.toFixed(prop['chart.txtbox.scale.decimals']), units_pre, units_post),//modificato io chart.txtbox.scale.decimals al posto di chart.scale.decimals per mettere decimale nella txtbox
                               'halign':'center',
                               'valign':'center',
                               'bounding':true,
                               'boundingFill':'white',
        ...
        this.grow = function ()
        {
            ...
            if (typeof obj.value === 'number') {
                ...
                var iterator = function ()
                {
                    ...
                    if (++frame < frames+(Math.abs(newValue/10))) {//aggiunto valore di correzione +(Math.abs(newValue/10)
