...
public :
	...
	csv_parser() : enclosed_char(0x00), 	escaped_char(0x5C),
				   ...
				   {original_pos=0; input_zzip_fp=NULL;}
	...
	bool init_zip(ZZIP_FILE * input_file_pointer);
	void _read_single_line_zip(char ** buffer, unsigned int * buffer_len);
	csv_row get_row_zip(void);


private :  size_t original_pos;
		  size_t current_pos;
		   ZZIP_FILE * input_zzip_fp;
	/**
